      ...
      <div class="card" style="background-color: #050A27">
        <div class="card-body pl-5 pb-5">
          ...
          <h5 class="mr-5 ml-3"><a href="index.php" style="color:white"> Penyewaan<br>Panggung</a></h5>
            ...
            <li class="nav-item">
              <a class="nav-link" href="DataTransaksi.php">Cari Pesanan Anda</a>
            </li>
          </ul>  
          ...
          <div class="row main mt-5">
            <div class="col-md-6">
              <h1 class="display-4">MENYEDIAKAN KEBUTUHAN PANGGUNG ANDA</h1>
              <p>Kami menyediakan paket-paket khusus untuk kebutuhan acara anda</p>
              <a href="ShowPackets.php" class="btn btn-primary">Pesan paketmu sekarang</a>
            </div>
          </div>
          <img src="img/gambar1.jpg" class="bg-img">
        </div>
      </div>     
    </div>
